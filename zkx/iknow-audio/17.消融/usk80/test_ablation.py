...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/17.消融/usk80/results_ablation.json"
PROGRESS_JSON = "/data/zkx/zkx/iknow-audio/17.消融/usk80/progress.json"
...
HOP2_RELATIONS = ["overlaps with", "part of scene", "used for"]
...
@torch.no_grad()
def main():
    print("Starting US8K ablation: Baseline / iKnow / Full2Hop / Ours / Selective2Hop_OriginalAgg / Selective2Hop_NoLLM")
    ...
    for sample_idx in tqdm(range(start_idx, total_samples), total=total_samples, initial=start_idx, desc="US8K ablation"):
