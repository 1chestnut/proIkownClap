...
@torch.no_grad()
def main():
    print("🚀 启动 iKnow-audio FSD50K 离线复现 (MS-CLAP 论文完全对齐版)...")
    ...
    print("\n" + "="*60)
    print(f"{'Metric':<12} | {'MS-CLAP (Baseline)':<18} | {'MS-CLAP +KG':<15}")
    print("-" * 60)
