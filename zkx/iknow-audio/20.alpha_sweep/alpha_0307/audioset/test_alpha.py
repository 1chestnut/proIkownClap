...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_0307/audioset/results_alpha.json"
...
@torch.no_grad()
def main():
    print("Starting AudioSet alpha_0307: Baseline / iKnow / Full2Hop / Selective2Hop")
    ...
    for sample in tqdm(iter_samples(dataset), total=dataset["total"], desc="AudioSet alpha_0307"):
