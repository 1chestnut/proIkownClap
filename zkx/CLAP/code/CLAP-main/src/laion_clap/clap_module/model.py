...
class CLAP(nn.Module):
    def __init__(
        ...
        if text_cfg.model_type == "transformer":
            ...
            self.text_branch = BertModel.from_pretrained("/home/star/zkx/CLAP/model/bert-base-uncased")
            self.text_transform = MLPLayers(units=[self.joint_embed_shape,
                                                   self.joint_embed_shape,
                                                   self.joint_embed_shape], dropout=0.1)
            self.text_projection = nn.Sequential(
            ...
            self.text_branch = RobertaModel.from_pretrained('/home/star/zkx/CLAP/model/roberta-base', local_files_only=True)
            self.text_transform = MLPLayers(units=[self.joint_embed_shape,
                                                   self.joint_embed_shape,
                                                   self.joint_embed_shape], dropout=0.1)
            self.text_projection = nn.Sequential(
            ...
            self.text_branch = BartModel.from_pretrained('/home/star/zkx/CLAP/model/bart-base')
            self.text_transform = MLPLayers(units=[self.joint_embed_shape,
                                                   self.joint_embed_shape,
                                                   self.joint_embed_shape], dropout=0.1)
            self.text_projection = nn.Sequential(
