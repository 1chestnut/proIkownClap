...
LOG="/data/zkx/zkx/iknow-audio/20.alpha_sweep/scheduler_gpu0_simple.log"
echo "START $(date)" | tee -a "$LOG"
jobs=(
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_0408_escfix/esc50"
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_035075/fsd50"
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_0307/fsd50"
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_035075/dcase"
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_0307/dcase"
)
p1=""; p2=""; l1=""; l2=""; idx=0
start_job() {
  local slot="$1"
