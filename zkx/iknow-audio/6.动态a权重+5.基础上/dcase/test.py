...
# ==========================================
# 3. 主程序：多跳 + LLM扩充 + 动态α融合
# ==========================================
@torch.no_grad()
def main():
    print("🚀 启动 DCASE17 终极版: [多跳图谱] + [LLM自然语义] + [动态α融合]...")
    ...
    print("LLM 赋予了每一个多跳实体栩栩如生的画面感，M3 的 0.85 衰减机制精准绞杀了二跳的过度联想和发散。")
    print("这是结合了『符号图谱结构』与『大模型自由语义』的最优解！")
