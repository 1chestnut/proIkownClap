...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_0408_escfix/esc50/results_alpha.json"
...
@torch.no_grad()
def main():
    print("Starting ESC50 alpha_0408_escfix: Baseline / iKnow / Full2Hop / Selective2Hop")
    ...
    for sample in tqdm(iter_samples(dataset), total=dataset["total"], desc="ESC50 alpha_0408_escfix"):
