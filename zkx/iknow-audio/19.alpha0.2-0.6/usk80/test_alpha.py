...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/19.alpha/usk80/results_alpha.json"
...
@torch.no_grad()
def main():
    print("Starting US8K test_alpha: Baseline / iKnow / Full2Hop / Selective2Hop")
    ...
    for sample in tqdm(iter_samples(dataset), total=dataset["total"], desc="US8K test_alpha"):
