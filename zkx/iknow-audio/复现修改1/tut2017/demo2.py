...
@torch.no_grad()
def main():
    print("🚀 启动 iKnow-audio TUT2017 (严格对齐 Algorithm 1 与 Figure 5)...")
    ...
    # ------------------ 🌟 关系设定 🌟 ------------------
    # 严格按照论文 Figure 5 针对 TUT2017 涨点最高的前 5 个关系
    ...
    print(f"🔗 使用对 TUT2017 最优的 {len(VALID_RELATIONS)} 个核心关系...")

    # 🌟 恢复正向查询（与 Algorithm 1 完全一致）
