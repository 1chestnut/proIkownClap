...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/19.alpha/dcase/results_alpha.json"
...
@torch.no_grad()
def main():
    print("Starting DCASE test_alpha: Baseline / iKnow / Full2Hop / Selective2Hop")
    ...
    for sample in tqdm(iter_samples(dataset), total=dataset["total"], desc="DCASE test_alpha"):
