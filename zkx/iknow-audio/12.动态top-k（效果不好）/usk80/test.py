...
# ==========================================
# 3. 主程序：多跳 + 双向自适应 (广度+深度) + 动态α
# ==========================================
@torch.no_grad()
def main():
    print("🚀 启动 US8K 双向自适应版: [🔥自适应广度] + [🔥自适应深度/早退] + [动态α]...")
    ...
    print(f"🎵 推理开始 (总计 {total_samples} 样本)...")
    ...
    print("💡 结论: 在 US8K 数据集上，模型彻底变成了一个极度精明的高手，对绝大多数送分题一瞥而过，仅对模糊样本进行重拳出击。")
