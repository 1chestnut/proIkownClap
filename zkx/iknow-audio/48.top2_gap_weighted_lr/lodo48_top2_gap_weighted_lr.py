...
from lodo48_top2_gap_weighted_lr_common import DatasetSpec, run_lodo_top2_gap_weighted_lr


ROOT = "/data/zkx/zkx/iknow-audio/39.materialize_features"
OUT_ROOT = "/data/zkx/zkx/iknow-audio/48.top2_gap_weighted_lr"
...
def main() -> None:
    ...
    run_lodo_top2_gap_weighted_lr(target_name, DATASETS, out_dir)
