...
LOG="/data/zkx/zkx/iknow-audio/20.alpha_sweep/scheduler_gpu1_simple.log"
echo "START $(date)" | tee -a "$LOG"
jobs=(
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_035075/audioset"
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_0307/audioset"
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_035075/tut2017"
  "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_0307/tut2017"
)
p1=""; p2=""; l1=""; l2=""; idx=0
start_job() {
  local slot="$1"
