...
# 🌟 DCASE17 自然语言字典路径
LLM_PROMPTS_PATH = "/home/star/zkx/iknow-audio/提示词扩展/dcase17/llm_prompts.json"
...
@torch.no_grad()
def main():
    print("🚀 启动 iKnow-audio DCASE17-T4 (统一创新版：自然语言 + Max Pooling + Alpha=0.85)...")
    ...
    print("\n" + "="*60)
    print(f"{'Metric':<12} | {'MS-CLAP (Baseline)':<20} | {'MS-CLAP +KG&NL':<20}")
    print("-" * 60)
