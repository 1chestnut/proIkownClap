...
OUTPUT_DIR = str(ROOT / '18diag' / 'tut2017_alpha_topk7_v3')
...
NEW_ALPHA_MAX = 0.6
NEW_TOP_K = 7
RESULT_KEY = 'Ours_AlphaTopK7V3'

def load_module(path):
    spec = importlib.util.spec_from_file_location('diag_tut2017_alpha_topk7_v3', path)
