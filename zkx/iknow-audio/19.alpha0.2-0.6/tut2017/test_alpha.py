...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/19.alpha/tut2017/results_alpha.json"
...
@torch.no_grad()
def main():
    print("Starting TUT2017 test_alpha: Baseline / iKnow / Full2Hop / Selective2Hop")
    ...
    for sample in tqdm(iter_samples(dataset), total=dataset["total"], desc="TUT2017 test_alpha"):
