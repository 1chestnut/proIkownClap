...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/20.alpha_sweep/alpha_035075/usk80/results_alpha.json"
...
@torch.no_grad()
def main():
    print("Starting US8K alpha_035075: Baseline / iKnow / Full2Hop / Selective2Hop")
    ...
    for sample in tqdm(iter_samples(dataset), total=dataset["total"], desc="US8K alpha_035075"):
