...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/16.综合/tut2017/test2/results_test2.json"
...
@torch.no_grad()
def main():
    print("Starting TUT2017 test2: Baseline / iKnow / Full2Hop / Selective2Hop")
    ...
    for sample in tqdm(iter_samples(dataset), total=dataset["total"], desc="TUT2017 test2"):
