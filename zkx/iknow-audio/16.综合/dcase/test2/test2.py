...
OUTPUT_JSON = "/data/zkx/zkx/iknow-audio/16.综合/dcase/test2/results_test2.json"
...
@torch.no_grad()
def main():
    print("Starting DCASE test2: Baseline / iKnow / Full2Hop / Selective2Hop")
    ...
    for sample in tqdm(iter_samples(dataset), total=dataset["total"], desc="DCASE test2"):
