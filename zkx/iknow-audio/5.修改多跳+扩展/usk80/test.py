...
@torch.no_grad()
def main():
    print("🚀 启动 US8K 终极版: [多跳图谱] + [LLM自然语义] + [M3衰减聚合]...")
    ...
    print("\n💡 终极版机制解析:")
    print("1. 广度：引入多跳扩展，大幅增加了候选知识节点。")
    print("2. 深度：引入 LLM，将冰冷的节点转化为极具声学画面感的描述语句。")
    print("3. 精度 (护城河)：采用 M3 机制 (Decay 0.85 + LogSumExp + Alpha 0.6) 严防多跳产生的 LLM 幻觉和噪音漂移。")
