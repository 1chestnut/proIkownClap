...
from lodo40_pilot_common import DatasetSpec, run_lodo_pilot


ROOT = "/data/zkx/zkx/iknow-audio/39.materialize_features"
OUT_ROOT = "/data/zkx/zkx/iknow-audio/40.lodo_router_pilot"
...
def main() -> None:
    ...
    run_lodo_pilot(target_name, DATASETS, out_dir)
